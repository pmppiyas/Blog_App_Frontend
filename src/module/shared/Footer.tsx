      ...
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="text-foreground flex gap-4">
            <Logo />
            <div>
              <h2 className='text-xl font-medium'>Prisma Blogs</h2>
              <p className='opacity-70'>The News, Real News</p>
            </div>
          </div>
        ...
        <div
          className="grid grid-cols-1 gap-8 border-t border-muted-foreground pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16 "
        >
          <div>
        ...
        <p className="text-xs  text-muted-foreground text-shadow-muted-foreground">
